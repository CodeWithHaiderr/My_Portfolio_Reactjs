  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
          ...
          <div className="flex items-center gap-3 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80
                reveal-up"
              >
                {icon}
              </a>
        ...
        <form action="https://getform.io/f/aqoodqya" method="POST" className="xl:pl-10 2xl:pl-20">
          ...
          <button className="btn btn-primary [&]:max-w-full w-full justify-center reveal-up">Submit</button>
        </form>
      </div>
    </section>
  );
